...
public class AppDemoView {
    ...
    public void help() {
        ...
        System.out.println("4) Добавить услугу");
        System.out.println("5) Изменить цену услуги");
        System.out.println("6) Добавить гостя");
        System.out.println("7) Записать услугу на гостя");
        System.out.println("8) Сортировать комнаты по цена/вместимость/звезды");
        System.out.println("9) Сортировка свободных номеров");
        System.out.println("10) Список постояльцев и их номеров");
        System.out.println("11) Общее число свободных номеров");
        System.out.println("12) Общее число постояльцев сегодня");
        System.out.println("13) Свободные номера на определенную дату");
        System.out.println("14) Сколько должен платить постоялец");
        System.out.println("15) Последние 3 постояльца комнаты");
        System.out.println("16) Список услуг постояльца и их цену");
        System.out.println("17) Цены услуг и номеров");
        System.out.println("18) Узнать детали комнаты");
        System.out.println("19) Удалить человека из номера");
        System.out.println("20) Выход - завершить программу");
        System.out.println("21) Help  / Помощь  — вывести этот список");
        System.out.println("======================================");
        System.out.println();
    }
}
