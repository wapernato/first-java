...
public class DeserializationGuestRegistry {
    ...
    public DeserializationGuestRegistry(){}

    public void deserializeGuest(){
        File fileGuest = new File("src/main/resources/GuestEntries.txt");
        File fileIds = new File("src/main/resources/GuestEntriesNextId.txt");
