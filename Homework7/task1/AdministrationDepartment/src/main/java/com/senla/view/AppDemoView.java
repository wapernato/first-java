...
public class AppDemoView {
    ...
    public void  printRoomDetails(Rooms rooms, String name,GuestRegistry guests, Integer roomsHistoryLimit){
        sorter.printRoomDetails(rooms, name, guests, roomsHistoryLimit);
    }
