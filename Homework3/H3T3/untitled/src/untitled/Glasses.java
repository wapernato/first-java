...
public class Glasses {
    ...
    public static class LensStep implements ILineStep {
        @Override
        public IProductPart buildProductPart() {
            System.out.println("Линза собрана");
            return new Part("Линза");

        }
    }

    public static class BowStep implements ILineStep {
        @Override
        public IProductPart buildProductPart() {
            System.out.println("Дужка собрана");
            return new Part("Дужка");
        }
    }
