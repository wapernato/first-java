...
public class Laptop {
    ...
    public static class BodyStep implements ILineStep {
        @Override
    ...
    public static class MotherboardStep implements ILineStep {
        @Override
        public IProductPart buildProductPart() {
            System.out.println("Материнская плата собрана");
            return new Part("Материнская плата");

        }
        }

    public static class ScreenStep implements ILineStep {
        @Override
        public IProductPart buildProductPart() {
            System.out.println("Монитор собран");
            return new Part("Монитор");
        }
    }
