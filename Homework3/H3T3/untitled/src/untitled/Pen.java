...
public class Pen {
    ...
    public static class SpringStep implements ILineStep {
        @Override
        public IProductPart buildProductPart() {
            System.out.println("Пружина собрана");
            return new Part("Пружина");

        }
    }

    public static class KernelStep implements ILineStep {
        @Override
        public IProductPart buildProductPart() {
            System.out.println("Стержень собран");
            return new Part("Стержень");
        }
    }
